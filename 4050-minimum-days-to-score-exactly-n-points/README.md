<h2><a href="https://leetcode.com/problems/minimum-days-to-score-exactly-n-points/">4050. Minimum Days to Score Exactly N Points</a></h2><h3>Medium</h3><hr><p>You are given an integer <code>n</code> representing a target score.</p>
